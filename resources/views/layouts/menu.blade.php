<ul id="sidebarnav">
    ...
    <li class="sidebar-item {{ Request::is('doadboard*') ? 'active' : '' }}"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{!! route('home') !!}"
            aria-expanded="false"><i class="mdi me-2 mdi-gauge"></i><span class="hide-menu">{{ trans('auth.home') }}</span></a>
    </li>
    ...
    <li class="sidebar-item {{ Request::is('doadboard*') ? 'active' : '' }}"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{!! route('users.index') !!}"
            aria-expanded="false">
            <i class="mdi me-2 mdi-account-check"></i><span class="hide-menu">{{ trans('auth.account_manager') }}</span></a>
    </li>

    <li class="sidebar-item {{ Request::is('doadboard*') ? 'active' : '' }}"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{!! route('manager_staff.index') !!}"
