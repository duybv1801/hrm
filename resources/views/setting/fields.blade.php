<div class="form-group row">
    <label class="col-sm-2 control-label" for="check_in_time">{{ trans('setting.check_in_time') }}</label>
    <div class="col-sm-8">
...
<!-- check_out_time -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="check_out_time">{{ trans('setting.check_out_time') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- flexible_time -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="flexible_time">{{ trans('setting.flexible_time') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- working_time -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="working_time">{{ trans('setting.working_time') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- lunch_time -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="lunch_time">{{ trans('setting.lunch_time') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
            <div class="input-group date timepicker" id="timepicker_lunch_time" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input" data-target="#timepicker_lunch_time"
                    value="{{ $settings[4]->value }}" name="lunch_time" id="lunch_time" data-toggle="datetimepicker">
            </div>
            <div id="lunch_time-error-msg" class="text-danger"></div>
        </div>
    </div>
</div>
...
<!-- flexible_lunch_time -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="flexible_lunch_time">{{ trans('setting.flexible_lunch_time') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
            <input type="number" class="form-control" value="{{ $settings[5]->value }}" name="flexible_lunch_time"
                id="flexible_lunch_time">
        </div>
        <div id="flexible_lunch_time-error-msg" class="text-danger"></div>
    </div>
</div>

<!-- female_leave -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="female_leave">{{ trans('setting.female_leave') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- paid_leave -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="paid_leave">{{ trans('setting.paid_leave') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- remote -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="remote">{{ trans('setting.remote') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- fresher_remote -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="fresher_remote">{{ trans('setting.fresher_remote') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- ot_night_time_end -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="ot_night_time_end">{{ trans('setting.ot_night_time_end') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- day_time_ot -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="day_time_ot">{{ trans('setting.day_time_ot') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- night_time_ot -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="night_time_ot">{{ trans('setting.night_time_ot') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- ot_day_dayoff -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="ot_day_dayoff">{{ trans('setting.ot_day_dayoff') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- ot_night_dayoff -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="ot_night_dayoff">{{ trans('setting.ot_night_dayoff') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- ot_day_holiday -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="ot_day_holiday">{{ trans('setting.ot_day_holiday') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<!-- ot_night_holiday -->
<div class="form-group row">
    <label class="col-sm-2 control-label" for="ot_night_holiday">{{ trans('setting.ot_night_holiday') }}</label>
    <div class="col-sm-8">
        <div class="input-group">
...
<div class="form-group row">
    <div class="col-sm-12">
        <input type="submit" class="btn btn-primary" value="Lưu" id="submit-button">
    </div>
</div>
